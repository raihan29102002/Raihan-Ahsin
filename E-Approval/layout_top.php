		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="<?=baseUrl();?>">
					<img src="libs/images/logo-pemkab-kediri.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Dinas Komunikasi dan Informatika Kabupaten Kediri</strong></div>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h4><?= str_replace(['e-Sertifikat', 'Dinas', 'Kediri'], ['e-Sertifikat<br />', '<b>Dinas', 'Kediri</b>'], APP_TITLE) ?></h4>
						...
						<ul class="nav nav-second-level">
							...
							if ($pagedesc == "Master Data") {
								echo '<li><a href="opd.php" class="active">Master Data</a></li>';
							} else {
								echo '<li><a href="opd.php">Data OPD</a></li>';
							}
							if ($pagedesc == "Master Acara") {
								echo '<li><a href="master_acara.php" class="active">Data Acara</a></li>';
							} else {
								echo '<li><a href="master_acara.php">Data Acara</a></li>';
							}
							?>
						</ul><!-- /.nav-second-level -->
						</li>
						...
						?>
						<a href="#"><i class="fa fa-download fa-fw"></i>&nbsp;Pengajuan Sertifikat<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php
							if ($pagedesc == "Awaiting") {
								echo '<li><a href="app_wait.php" class="active">Awaiting</a></li>';
							} else {
								echo '<li><a href="app_wait.php">Awaiting</a></li>';
							}
							...
							if ($pagedesc == "Declined") {
								echo '<li><a href="app_decline.php" class="active">Declined</a></li>';
							} else {
								echo '<li><a href="app_decline.php">Declined</a></li>';
							}
